...
# 5. Command: Set Column
    ...
    sb x4, 0(x7)
    addi x4, x0, 0x50           # x4: 0x50          (SetCol Data 2 - SC[L]) 
    sb x4, 0(x7)
    addi x4, x0, 0x01           # x4: 0x01          (SetCol Data 3 - EC[H]) 
    sb x4, 0(x7)
    addi x4, x0, 0x8F           # x4: 0x3F          (SetCol Data 4 - EC[L]) 
    sb x4, 0(x7)
# 6. Command: Set Row
    addi x4, x0, 0b00010000    # x4: 0x10          (W-4DATA) 
    sb x4, 0(x5)
    ...
    sb x4, 0(x7)
    addi x4, x0, 0x28           # x4: 0x00          (SetRow Data 2 - SR[L]) 
    sb x4, 0(x7)
    addi x4, x0, 0x01           # x4: 0x00          (SetRow Data 3 - ER[H]) 
    sb x4, 0(x7)
    addi x4, x0, 0x17           # x4: 0xEF          (SetRow Data 4 - ER[L]) 
    sb x4, 0(x7)
# 7. Command: Sleep OUT
    addi x4, x0, 0b00000000    # x4: 0x02          (W-0DATA) 
    sb x4, 0(x5)
